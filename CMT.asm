...
.L19:	LD	HL,(BASBEGIN)		;HL<-BASIC先頭アドレス
	CALL	GET_FIREWALL		;DE<-スタックエリアとフリーエリアの境界値
.L12:	LD	B,BAS_ZERO		;=ファイル終了と判断する00Hの数(ゼロカウンタ)
.L13:	PUSH	BC			;

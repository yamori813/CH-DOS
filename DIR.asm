...
;.L23:	LD	DE,DENT_SIZE			;バッファポインタを次のエントリの先頭に進める
;	ADD	HL,DE				;
;	DJNZ	.L21				;ディレクトリエントリの数だけ繰り返す
;	CALL	DW0_INC				;セクタ＃++
;	POP	BC				;ループ回数を復帰
;	DJNZ	.L22				;クラスタの最終セクタまで処理する
;	POP	HL				;クラスタ＃を復帰
;	LD	A,H				;
;	OR	L				;
